...
function tbv2_render_scripts() {
    ...
    const TBV2_Form = {
        ...
        createRedsysPaymentForm(orderData) {
            ...
            const completeFormData = JSON.parse(sessionStorage.getItem('tbv2_complete_form_data') || '{}');
        ...
        if (submitPaymentBtn) {
            submitPaymentBtn.addEventListener('click', async function(e) {
                ...
                try {
                    ...
                    sessionStorage.setItem('tbv2_complete_form_data', JSON.stringify(completeFormData));
