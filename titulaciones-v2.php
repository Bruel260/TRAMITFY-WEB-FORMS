    ...
    (function() {
        function ttv2_initCoupon() {
            ...
            btn.addEventListener('click', async function() {
                ...
                try {
                    const price = (typeof ttv2FormData !== 'undefined' && ttv2FormData.amount) ? ttv2FormData.amount : (typeof ttv2SelectedPrice !== 'undefined' ? ttv2SelectedPrice : 55);
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', ttv2_initCoupon);
        } else {
            ttv2_initCoupon();
        }
    })();
