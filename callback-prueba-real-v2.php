...
callback_log("Headers: " . json_encode(getallheaders() ?: $_SERVER), "HEADERS", "INFO");
callback_log("GET params: " . json_encode($_GET), "GET-PARAMS", "INFO");
callback_log("POST params: " . json_encode($_POST), "POST-PARAMS", "INFO");
