...
if (!defined('HOJA_ASIENTO_STRIPE_TEST_PUBLIC_KEY')) {
    define('HOJA_ASIENTO_STRIPE_TEST_PUBLIC_KEY', 'pk_test_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
}
if (!defined('HOJA_ASIENTO_STRIPE_TEST_SECRET_KEY')) {
    define('HOJA_ASIENTO_STRIPE_TEST_SECRET_KEY', 'sk_test_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
}
