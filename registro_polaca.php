    ...
    (function() {
        function pol_initCoupon() {
            ...
            btn.addEventListener('click', async function() {
                ...
                try {
                    const price = typeof calculateTotal === 'function' ? calculateTotal() : 0;
                    ...
                    if (data.valid) {
                        ...
                        const newPrice = Math.max(0, price - data.clientDiscount); const el = document.getElementById('summary-total-price'); if (el) el.textContent = newPrice.toFixed(2).replace('.', ',') + ' €';
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', pol_initCoupon);
        } else {
            pol_initCoupon();
        }
    })();
