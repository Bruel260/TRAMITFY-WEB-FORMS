...
function generador_contrato_shortcode() {
    ...
    <style>
        ...
        .progress-step.active {
            background: var(--secondary);
            box-shadow: 0 0 20px rgba(2, 249, 210, 0.4);
            transform: scale(1.1);
        }
        ...
        .form-control.valid {
            ...
            background: linear-gradient(90deg, white 95%, var(--success) 95%);
        }

        .form-control.invalid {
            border-color: var(--danger);
            background: linear-gradient(90deg, white 95%, var(--danger) 95%);
            ...
            <div class="contrato-form-panel">
                ...
                <form id="contrato-form">
                    ...
                    <div class="form-step active" id="step-1">
                        ...
                        <div class="form-row three-cols">
                            <div class="form-group">
                                ...
                                <small style="color: #666; font-size: 11px;">Año de construcción</small>
                            </div>
                            <div class="form-group">
                                ...
                                <small style="color: #666; font-size: 11px;">Identificación única</small>
                            </div>
                            <div class="form-group">
                                <label for="matricula">Matrícula/Folio</label>
                                <input type="text" class="form-control" id="matricula" name="matricula" placeholder="MAD-1234-AB" maxlength="15">
                                <small style="color: #666; font-size: 11px;">Registro oficial</small>
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label for="precio">Precio de venta (€) *
                                    <span class="tooltip-trigger">💡
                                        <div class="tooltip-content">Precio total en euros sin decimales. Ej: 45000</div>
                                    </span>
                                </label>
                                <input type="number" class="form-control" id="precio" name="precio" placeholder="Ej: 45000" min="1">
                                <div class="validation-message" id="precio-validation"></div>
                    ...
                    <div class="form-step" id="step-2">
                        ...
                        <div class="form-row three-cols">
                            <div class="form-group">
                                <label for="vendedor-dni">DNI/NIE *
                                    <span class="tooltip-trigger">ℹ️
                                        <div class="tooltip-content">Formato válido: 12345678A (DNI) o X1234567A (NIE)</div>
                                    </span>
                                </label>
                                <input type="text" class="form-control" id="vendedor-dni" name="vendedorDni" placeholder="12345678A">
                                <div class="validation-message" id="vendedor-dni-validation"></div>
                    ...
                    <div class="form-step" id="step-3">
                        ...
                        <div class="form-row three-cols">
                            <div class="form-group">
                                <label for="comprador-dni">DNI/NIE *
                                    <span class="tooltip-trigger">ℹ️
                                        <div class="tooltip-content">Formato válido: 12345678A (DNI) o X1234567A (NIE)</div>
                                    </span>
                                </label>
                                <input type="text" class="form-control" id="comprador-dni" name="compradorDni" placeholder="12345678A">
                                <div class="validation-message" id="comprador-dni-validation"></div>
                                <div class="error-message">Por favor introduce el DNI/NIE</div>
                            </div>
                            <div class="form-group">
    ...
    <div class="loading-overlay" id="loading-overlay">
        <div>
            ...
            <div class="loading-text" id="loading-text">Generando contrato...</div>
        </div>
    </div>
    ...
    <script>
        ...
        function validateDNI(dni) {
            ...
            if (/^[XYZ][0-9]{7}[A-Z]$/.test(dni)) {
                const conversions = {'X': '0', 'Y': '1', 'Z': '2'};
                const numero = conversions[dni[0]] + dni.substring(1, 8);
                const letra = dni.substring(8, 9);
                const letras = "TRWAGMYFPDXBNJZSQVHLCKE";
                return letras[numero % 23] === letra;
            }
        ...
        function addRealTimeValidation() {
            // Validación DNI vendedor
            document.getElementById('vendedor-dni').addEventListener('input', function() {
                const isValid = validateDNI(this.value);
                showValidationMessage('vendedor-dni', isValid, 
                    isValid ? '✓ DNI/NIE válido' : '✗ Formato de DNI/NIE incorrecto');
            });

            // Validación DNI comprador
            document.getElementById('comprador-dni').addEventListener('input', function() {
                const isValid = validateDNI(this.value);
                showValidationMessage('comprador-dni', isValid, 
                    isValid ? '✓ DNI/NIE válido' : '✗ Formato de DNI/NIE incorrecto');
            });
            ...
            document.getElementById('precio').addEventListener('input', function() {
                ...
                const isValid = price > 0 && price < 10000000;
                showValidationMessage('precio', isValid, 
                    isValid ? '✓ Precio válido' : '✗ El precio debe ser mayor que 0');
            });
        }
        ...
        function showValidationMessage(fieldId, isValid, message) {
            ...
            // Mostrar mensaje
            validationDiv.className = `validation-message show ${isValid ? 'success' : 'error'}`;
        ...
        function generarYEnviarContratoPDF() {
            ...
            // Mostrar loading
            showLoading('Generando tu contrato...');
