...
function generador_contrato_shortcode() {
    ...
    <style>
        ...
        /* NOTIFICACIONES MODERNAS INTEGRADAS */
        ...
        /* PESTAÑA DE CONFIRMACIÓN DE ENVÍO */
        ...
        /* ========================================
           PANTALLA DE CARGA MODERNA Y ORGÁNICA
           ======================================== */
        .tramitfy-loading-overlay {
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(1, 109, 134, 0.95), rgba(2, 249, 210, 0.1));
        ...
        .tramitfy-loading-overlay.active {
            opacity: 1;
            visibility: visible;
        }

        .tramitfy-loading-container {
            text-align: center;
            max-width: 400px;
            padding: 40px;
        ...
        .tramitfy-loading-overlay.active .tramitfy-loading-container {
            transform: translateY(0);
        }

        .tramitfy-loading-icon {
            width: 80px;
            height: 80px;
            margin: 0 auto 30px;
            position: relative;
        ...
        .tramitfy-loading-wave {
            width: 100%;
            height: 100%;
            border: 3px solid rgba(255, 255, 255, 0.2);
            border-radius: 50%;
            position: absolute;
            animation: tramitfy-wave 2s infinite ease-in-out;
        }

        .tramitfy-loading-wave:nth-child(2) {
            animation-delay: -0.5s;
        }

        .tramitfy-loading-wave:nth-child(3) {
            animation-delay: -1s;
        }

        .tramitfy-loading-inner {
            width: 40px;
            height: 40px;
            ...
            left: 50%;
            transform: translate(-50%, -50%);
            animation: tramitfy-pulse 1.5s infinite ease-in-out;
        }

        @keyframes tramitfy-wave {
            0% {
                transform: scale(0.8);
                border-color: rgba(2, 249, 210, 0.8);
            }
            50% {
                transform: scale(1.2);
                border-color: rgba(1, 109, 134, 0.4);
            }
            100% {
                transform: scale(0.8);
                border-color: rgba(2, 249, 210, 0.8);
        ...
        @keyframes tramitfy-pulse {
            0%, 100% {
                transform: translate(-50%, -50%) scale(1);
                box-shadow: 0 0 0 0 rgba(2, 249, 210, 0.7);
            }
            50% {
                transform: translate(-50%, -50%) scale(1.1);
                box-shadow: 0 0 0 20px rgba(2, 249, 210, 0);
            }
        }

        .tramitfy-loading-title {
            color: white;
            font-size: 24px;
            font-weight: 600;
            margin-bottom: 12px;
        ...
        .tramitfy-loading-steps {
            max-width: 300px;
            margin: 0 auto;
        }

        .tramitfy-loading-step {
            display: flex;
            align-items: center;
            padding: 8px 0;
        ...
        .tramitfy-loading-step.active {
            color: var(--secondary);
            font-weight: 500;
        }

        .tramitfy-loading-step.completed {
            color: rgba(255, 255, 255, 0.4);
        }

        .tramitfy-loading-step-icon {
            width: 16px;
            height: 16px;
            margin-right: 12px;
            opacity: 0.5;
        ...
        .tramitfy-loading-step.active .tramitfy-loading-step-icon {
            opacity: 1;
            transform: scale(1.1);
        }

        .tramitfy-loading-step.completed .tramitfy-loading-step-icon {
            opacity: 0.3;
        }

        /* Animación de entrada suave */
        @keyframes tramitfy-fade-in {
            from {
                opacity: 0;
        ...
        .tramitfy-loading-overlay.active {
            animation: tramitfy-fade-in 0.6s cubic-bezier(0.4, 0, 0.2, 1);
        }

        /* ========================================
           DESPLEGABLE DE DATOS DEL MOTOR
           ======================================== */
        .motor-dropdown {
            background: var(--light);
        ...
        .motor-dropdown-header:hover {
            background: linear-gradient(135deg, #e9ecef, #dee2e6);
        }

        .motor-dropdown-header.active {
            background: linear-gradient(135deg, var(--primary-light), #e6f5f7);
            color: var(--primary);
            font-weight: 500;
        }

        .motor-dropdown-title {
            font-size: 14px;
            font-weight: 500;
            color: #666;
            display: flex;
        ...
        .motor-dropdown-header.active .motor-dropdown-title {
            color: var(--primary);
        }
        ...
        .motor-dropdown-header.active .motor-dropdown-icon {
            transform: rotate(180deg);
            color: var(--primary);
        }

        .motor-dropdown-content {
            padding: 0;
            max-height: 0;
            overflow: hidden;
        ...
        .motor-input-field:focus {
            outline: none;
            border-color: var(--primary);
            box-shadow: 0 0 0 3px rgba(1, 109, 134, 0.1);
        }

        .motor-input-field::placeholder {
            color: #999;
            font-style: italic;
        }
        ...
        /* OPTIMIZACIÓN DE ESPACIOS - AJUSTE DINÁMICO */
        .contrato-wrapper {
        ...
        /* Reducir espacios excesivos al final */
        .form-step:last-child {
            margin-bottom: 10px;
        }
        
        .contrato-form-panel > form {
            margin-bottom: 0;
        }
        ...
        /* SIDEBAR COMO MENÚ DE NAVEGACIÓN */
        .navigation-sidebar {
            background: linear-gradient(135deg, var(--primary) 0%, var(--primary-dark) 100%);
            color: white;
            padding: 15px;
        ...
        .nav-step.active .nav-step-content {
            max-height: 300px;
            padding: 15px;
        }
        ...
        .form-welcome-overlay {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(240, 244, 248, 0.95) 0%, rgba(226, 232, 240, 0.95) 100%);
            display: flex;
            align-items: center;
            justify-content: center;
            z-index: 10;
        ...
        .form-welcome-overlay:hover .welcome-content {
        ...
        .welcome-cta {
            ...
            cursor: pointer;
            transition: all 0.3s ease;
            box-shadow: 0 8px 25px rgba(1, 109, 134, 0.3);
            display: inline-flex;
            align-items: center;
            gap: 10px;
        }
        ...
        .welcome-cta:hover {
            ...
            box-shadow: 0 12px 35px rgba(1, 109, 134, 0.4);
        }
        ...
        /* Responsive para la pantalla de bienvenida */
        @media (max-width: 768px) {
            .welcome-content {
                margin: 20px;
                padding: 30px 20px;
    ...
    <div class="tramitfy-loading-overlay" id="tramitfy-loading">
        <div class="tramitfy-loading-container">
            <div class="tramitfy-loading-icon">
                <div class="tramitfy-loading-wave"></div>
                <div class="tramitfy-loading-wave"></div>
                <div class="tramitfy-loading-wave"></div>
                <div class="tramitfy-loading-inner"></div>
            </div>
            
            <h3 class="tramitfy-loading-title">Generando tu contrato</h3>
            <p class="tramitfy-loading-subtitle">Procesando la información y preparando el documento profesional</p>
            
            <div class="tramitfy-loading-steps">
                <div class="tramitfy-loading-step active" id="step-validating">
                    <span class="tramitfy-loading-step-icon">✓</span>
                    <span>Validando datos del formulario</span>
                </div>
                <div class="tramitfy-loading-step" id="step-generating">
                    <span class="tramitfy-loading-step-icon">📄</span>
                    <span>Generando documento PDF</span>
                </div>
                <div class="tramitfy-loading-step" id="step-sending">
                    <span class="tramitfy-loading-step-icon">📧</span>
                    <span>Enviando a tu email</span>
                </div>
                <div class="tramitfy-loading-step" id="step-saving">
                    <span class="tramitfy-loading-step-icon">💾</span>
        ...
        <div class="contrato-layout">
            ...
            <div class="navigation-sidebar">
                <div class="navigation-header">
                    <h2 class="navigation-title">📋 Progreso del Contrato</h2>
                    <p class="navigation-subtitle">Navega entre las secciones</p>
                </div>

                <!-- Paso 1: Datos de la embarcación -->
                <div class="nav-step active" id="nav-step-1" onclick="navigateToStep(1)">
                    <div class="nav-step-header">
                        <div class="nav-step-info">
                            <div class="nav-step-number">1</div>
                            <div class="nav-step-title">🚤 Datos de la Embarcación</div>
                        </div>
                        <div class="nav-step-icon">▶</div>
                    </div>
                    <div class="nav-step-content">
                        <div class="nav-data-item">
                            <span class="nav-data-label">Tipo:</span> 
                            <span class="nav-data-value" id="nav-tipo-vehiculo">[Seleccionar tipo]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Marca:</span> 
                            <span class="nav-data-value" id="nav-marca">[Introducir marca]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Modelo:</span> 
                            <span class="nav-data-value" id="nav-modelo">[Introducir modelo]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Año:</span> 
                            <span class="nav-data-value" id="nav-ano">[Introducir año]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Matrícula:</span> 
                            <span class="nav-data-value" id="nav-matricula">[Introducir matrícula]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Precio:</span> 
                            <span class="nav-data-value" id="nav-precio">[Introducir precio]</span>
                        </div>
                    </div>
                </div>

                <!-- Paso 2: Parte vendedora -->
                <div class="nav-step" id="nav-step-2" onclick="navigateToStep(2)">
                    <div class="nav-step-header">
                        <div class="nav-step-info">
                            <div class="nav-step-number">2</div>
                            <div class="nav-step-title">👤 Parte Vendedora</div>
                        </div>
                        <div class="nav-step-icon">▶</div>
                    </div>
                    <div class="nav-step-content">
                        <div class="nav-data-item">
                            <span class="nav-data-label">Nombre:</span> 
                            <span class="nav-data-value" id="nav-vendedor-nombre">[Nombre del vendedor]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">DNI/NIE:</span> 
                            <span class="nav-data-value" id="nav-vendedor-dni">[DNI/NIE]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Dirección:</span> 
                            <span class="nav-data-value" id="nav-vendedor-direccion">[Dirección completa]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Teléfono:</span> 
                            <span class="nav-data-value" id="nav-vendedor-telefono">[Teléfono]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Email:</span> 
                            <span class="nav-data-value" id="nav-vendedor-email">[Email]</span>
                        </div>
                    </div>
                </div>

                <!-- Paso 3: Parte compradora -->
                <div class="nav-step" id="nav-step-3" onclick="navigateToStep(3)">
                    <div class="nav-step-header">
                        <div class="nav-step-info">
                            <div class="nav-step-number">3</div>
                            <div class="nav-step-title">👤 Parte Compradora</div>
                        </div>
                        <div class="nav-step-icon">▶</div>
                    </div>
                    <div class="nav-step-content">
                        <div class="nav-data-item">
                            <span class="nav-data-label">Nombre:</span> 
                            <span class="nav-data-value" id="nav-comprador-nombre">[Nombre del comprador]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">DNI/NIE:</span> 
                            <span class="nav-data-value" id="nav-comprador-dni">[DNI/NIE]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Dirección:</span> 
                            <span class="nav-data-value" id="nav-comprador-direccion">[Dirección completa]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Teléfono:</span> 
                            <span class="nav-data-value" id="nav-comprador-telefono">[Teléfono]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Email:</span> 
                            <span class="nav-data-value" id="nav-comprador-email">[Email]</span>
                        </div>
                    </div>
                </div>

                <!-- Paso 4: Condiciones de venta -->
                <div class="nav-step" id="nav-step-4" onclick="navigateToStep(4)">
                    <div class="nav-step-header">
                        <div class="nav-step-info">
                            <div class="nav-step-number">4</div>
                            <div class="nav-step-title">📋 Condiciones de Venta</div>
                        </div>
                        <div class="nav-step-icon">▶</div>
                    </div>
                    <div class="nav-step-content">
                        <div class="nav-data-item">
                            <span class="nav-data-label">Forma de pago:</span> 
                            <span class="nav-data-value" id="nav-forma-pago">[Seleccionar forma de pago]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Lugar de entrega:</span> 
                            <span class="nav-data-value" id="nav-lugar-entrega">[Introducir lugar de entrega]</span>
                        </div>
                        <div class="nav-data-item">
                            <span class="nav-data-label">Observaciones:</span> 
                            <span class="nav-data-value" id="nav-observaciones">[Observaciones adicionales]</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="navigation-footer">
                    <p style="font-size: 12px; color: rgba(255,255,255,0.8); margin: 0;">
                        📄 El contrato se generará automáticamente
                    </p>
                    <p style="font-size: 10px; color: rgba(255,255,255,0.6); margin: 5px 0 0 0;">
                        Haz click en cualquier paso para navegar
                    </p>
                </div>
            </div>
            ...
            <div class="contrato-form-panel">
                ...
                <div class="form-welcome-overlay" id="welcome-overlay" onclick="startForm()">
                    <div class="welcome-content">
                        <p class="welcome-subtitle">
                            Crea contratos profesionales de embarcaciones de forma rápida y sencilla
                        </p>
                        <p class="welcome-hint">
                            Haz click en cualquier sitio para empezar
                        </p>
                    </div>
                </div>
                ...
                <form id="contrato-form">
                    ...
                    <div class="form-step active" id="step-1">
                        ...
                        <!-- DESPLEGABLE COMPACTO DE DATOS DEL MOTOR -->
                        <div class="motor-dropdown">
                            <div class="motor-dropdown-header" onclick="toggleMotorDropdown()">
                                <div class="motor-dropdown-title">
                                    <span>⚙️</span>
                                    <span>Datos del motor (recomendado)</span>
                                </div>
                                <div class="motor-dropdown-icon">▼</div>
                            </div>
                            <div class="motor-dropdown-content" id="motor-dropdown-content">
                                <textarea 
                                    class="motor-input-field" 
                                    id="motor" 
                                    name="motor" 
                                    placeholder="Ej: Volvo Penta D2-40, 40HP, año 2018, nº serie: 123456"
                                ></textarea>
                                <div class="motor-dropdown-hint">
                                    💡 Incluir marca, modelo, potencia, año y número de serie ayuda a dar más valor al contrato
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-step" id="step-4">
                        ...
                        <div class="clausulas-section">
                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-itp" name="clausulas[]" value="itp" checked>
                                <label for="clausula-itp">
                                    <strong>💰 Impuesto de Transmisiones Patrimoniales (ITP)</strong><br>
                                    <small>El comprador se hace cargo del ITP (6-8% del valor según CCAA). Obligatorio por ley.</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-tramitacion" name="clausulas[]" value="tramitacion" checked>
                                <label for="clausula-tramitacion">
                                    <strong>📄 Gastos de tramitación</strong><br>
                                    <small>Los gastos de cambio de titularidad en Capitanía Marítima serán a cargo del comprador.</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-inspeccion" name="clausulas[]" value="inspeccion" checked>
                                <label for="clausula-inspeccion">
                                    <strong>🔍 Estado de la embarcación</strong><br>
                                    <small>El comprador acepta la embarcación tras inspección, en su estado actual y funcionamiento.</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-seguro" name="clausulas[]" value="seguro">
                                <label for="clausula-seguro">
                                    <strong>🛡️ Seguro obligatorio</strong><br>
                                    <small>El comprador se compromete a contratar seguro obligatorio antes de la navegación.</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-deudas" name="clausulas[]" value="deudas">
                                <label for="clausula-deudas">
                                    <strong>💸 Deudas pendientes</strong><br>
                                    <small>El vendedor garantiza que no existen deudas pendientes (puertos, multas, etc.).</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-entrega" name="clausulas[]" value="entrega">
                                <label for="clausula-entrega">
                                    <strong>📅 Fecha de entrega</strong><br>
                                    <small>La entrega se realizará el día del pago completo en el lugar acordado.</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-garantia" name="clausulas[]" value="garantia">
                                <label for="clausula-garantia">
                                    <strong>⚠️ Limitación de garantía</strong><br>
                                    <small>Venta sin garantía comercial. Solo garantía legal por vicios ocultos graves.</small>
                                </label>
                            </div>

                            <div class="clausula-option">
                                <input type="checkbox" id="clausula-motor" name="clausulas[]" value="motor">
                                <label for="clausula-motor">
                                    <strong>⚙️ Estado del motor</strong><br>
                                    <small>El motor ha sido probado y funciona correctamente en el momento de la venta.</small>
                                </label>
                            </div>
                        </div>
                ...
                <!-- Botones de administrador (solo visibles para administradores) -->
                <div style="text-align: center; padding: 15px 10px 5px 10px; border-top: 1px solid var(--border); margin-top: 15px;">
                    <button
                        id="btn-test-data"
    ...
    <!-- COMPONENTES MODERNOS DE NOTIFICACIÓN -->
    <div class="notification-container" id="notification-container"></div>
    
    <!-- MODAL MODERNO DE CONFIRMACIÓN -->
    <div class="modern-modal" id="modern-modal">
        <div class="modern-modal-content">
            <div class="modern-modal-header">
                <span class="modern-modal-icon" id="modal-icon"></span>
                <h3 class="modern-modal-title" id="modal-title"></h3>
                <p class="modern-modal-message" id="modal-message"></p>
            </div>
            <div class="modern-modal-actions" id="modal-actions"></div>
        </div>
    </div>
    ...
    <script>
        ...
        function startForm() {
            ...
            // Opcional: pequeña animación de entrada para el formulario
            setTimeout(() => {
        ...
        // Función para rellenar TODOS los datos de prueba (solo para administradores)
        function fillTestData() {
            // Confirmación moderna para administradores
            modernConfirm('¿Rellenar TODOS los datos de prueba?', () => {
                proceedWithTestData();
            });
        }

        function proceedWithTestData() {
            ...
            showNotification('success', 'Datos de prueba completados', 'Todos los datos de prueba han sido rellenados correctamente');
        }
        ...
        function setupEventListeners() {
            ...
            // Ya no necesitamos uploads de archivos PDF
        }

        // Función de upload eliminada - ya no necesitamos documentación PDF
        ...
        function showStep(step) {
            ...
            // Actualizar sidebar de navegación
            updateNavigationSidebar(step);
        ...
        // Nueva función para navegación desde el sidebar
        function navigateToStep(step) {
            // Validar que no se navegue a pasos futuros sin completar los anteriores
            if (step > currentStep + 1) {
                showNotification('Completa el paso actual antes de continuar', 'warning');
                return;
            }
        ...
        // Función para actualizar el estado del sidebar de navegación
        function updateNavigationSidebar(currentStep) {
            // Remover clase active de todos los pasos del sidebar
            document.querySelectorAll('.nav-step').forEach(step => {
                step.classList.remove('active');
            });
            
            // Marcar el paso actual como activo
            const activeNavStep = document.getElementById(`nav-step-${currentStep}`);
            if (activeNavStep) {
                activeNavStep.classList.add('active');
            }
            
            // Marcar pasos completados
            for (let i = 1; i < currentStep; i++) {
                const completedStep = document.getElementById(`nav-step-${i}`);
                if (completedStep) {
        ...
        // Función para actualizar los datos en el sidebar de navegación
        function updateNavigationData() {
            // Paso 1: Datos de la embarcación
            const tipoVehiculo = document.querySelector('input[name="tipoVehiculo"]:checked');
            updateNavField('nav-tipo-vehiculo', tipoVehiculo?.value === 'moto' ? 'Moto Acuática' : 'Embarcación');
            updateNavField('nav-marca', document.getElementById('marca')?.value);
            updateNavField('nav-modelo', document.getElementById('modelo')?.value);
            updateNavField('nav-ano', document.getElementById('ano')?.value);
            updateNavField('nav-matricula', document.getElementById('matricula')?.value);
            
            const precio = document.getElementById('precio')?.value;
            if (precio) {
                updateNavField('nav-precio', formatCurrency(precio));
            }

            // Paso 2: Vendedor
            updateNavField('nav-vendedor-nombre', document.getElementById('vendedor-nombre')?.value);
            updateNavField('nav-vendedor-dni', document.getElementById('vendedor-dni')?.value);
            updateNavField('nav-vendedor-direccion', document.getElementById('vendedor-direccion')?.value);
            updateNavField('nav-vendedor-telefono', document.getElementById('vendedor-telefono')?.value);
            updateNavField('nav-vendedor-email', document.getElementById('vendedor-email')?.value);

            // Paso 3: Comprador
            updateNavField('nav-comprador-nombre', document.getElementById('comprador-nombre')?.value);
            updateNavField('nav-comprador-dni', document.getElementById('comprador-dni')?.value);
            updateNavField('nav-comprador-direccion', document.getElementById('comprador-direccion')?.value);
            updateNavField('nav-comprador-telefono', document.getElementById('comprador-telefono')?.value);
            updateNavField('nav-comprador-email', document.getElementById('comprador-email')?.value);

            // Paso 4: Condiciones
            updateNavField('nav-forma-pago', document.getElementById('forma-pago')?.value);
            updateNavField('nav-lugar-entrega', document.getElementById('lugar-entrega')?.value);
            updateNavField('nav-observaciones', document.getElementById('observaciones')?.value);
        }

        // Función auxiliar para actualizar campos del sidebar
        function updateNavField(navId, value) {
        ...
        function validateCurrentStep() {
            ...
            // Ya no necesitamos validaciones de documentación PDF
        ...
        // Función para toggle del dropdown de motor
        function toggleMotorDropdown() {
            const header = document.querySelector('.motor-dropdown-header');
            const content = document.querySelector('.motor-dropdown-content');
            const icon = document.querySelector('.motor-dropdown-icon');
        ...
        function updatePreview() {
            ...
            // Tipo de vehículo
            const tipoVehiculo = document.querySelector('input[name="tipoVehiculo"]:checked');
            const prevTipoElement = document.getElementById('prev-tipo-vehiculo');
            if (prevTipoElement) {
                prevTipoElement.textContent = tipoVehiculo?.value === 'moto' ? 'Moto Acuática' : 'Embarcación';
            }
            ...
            if (precio) {
                ...
                const prevPrecioTexto = document.getElementById('prev-precio-texto');
                if (prevPrecio) prevPrecio.textContent = formatCurrency(precio);
                if (prevPrecioTexto) prevPrecioTexto.textContent = formatCurrency(precio);
            }

            // Mostrar/ocultar info del motor
            const motorField = document.getElementById('motor');
            const motorInfo = document.getElementById('motor-info');
            if (motorField && motorInfo) {
                if (motorField.value.trim()) {
        ...
        function updateClausulasPreview() {
            // Solo ejecutar si tenemos los elementos necesarios (sidebar antiguo)
            ...
            // Si no existen los elementos del sidebar antiguo, no hacer nada
            if (!clausulasContainer || !clausulasList) {
                return;
            }
            ...
            const clausulasPersonalizadasElement = document.getElementById('clausulas-personalizadas');
            const clausulasPersonalizadas = clausulasPersonalizadasElement ? clausulasPersonalizadasElement.value.trim() : '';
        ...
        function generarContrato() {
            ...
            updatePreview(); // Esto actualiza contratoData automáticamente
            console.log('✅ Datos del formulario recopilados correctamente');
            ...
            // Mostrar sección de email integrada en lugar de prompt
            showEmailRequestSection(suggestedEmail);
            return; // Parar aquí, el flujo continúa desde la sección de email
        }

        function showEmailRequestSection(suggestedEmail = '') {
            const emailSection = document.createElement('div');
            emailSection.className = 'email-request-section active';
            emailSection.id = 'email-request-section';
            
            emailSection.innerHTML = `
                <div class="email-request-title">
                    📧 ¿Dónde quieres recibir tu contrato?
                </div>
                <p style="margin: 0 0 16px 0; color: #666; font-size: 14px;">
                    Te enviaremos el contrato en PDF listo para firmar
                </p>
                <input type="email" class="email-request-input" id="email-request-input" 
                       placeholder="tu@email.com" value="${suggestedEmail}">
                <div class="email-request-actions">
                    <button class="modern-modal-btn secondary" onclick="cancelEmailRequest()">
                        Cancelar
                    </button>
                    <button class="modern-modal-btn primary" onclick="confirmEmailRequest()">
                        📧 Generar contrato
                    </button>
                </div>
            `;
            
            // Verificar si ya existe una sección de email
            const existingSection = document.getElementById('email-request-section');
            if (existingSection) {
                existingSection.remove();
            }

            // Insertar la sección en un lugar seguro del formulario
            const formPanel = document.querySelector('.contrato-form-panel');
            if (formPanel) {
                // Insertar al final del panel del formulario
                formPanel.appendChild(emailSection);
            } else {
                // Fallback extremo: insertar en el body
                document.body.appendChild(emailSection);
            }
            
            // Focus en el input
            setTimeout(() => {
                document.getElementById('email-request-input').focus();
            }, 100);
        }

        function confirmEmailRequest() {
            const userEmail = document.getElementById('email-request-input').value.trim();
            ...
            if (!userEmail || !isValidEmail(userEmail)) {
                ...
                hideTramitfyLoading();
                setTimeout(() => {
                    showNotification('error', 'Email inválido', 'Por favor introduce un email válido');
                }, 300);
                return;
            }
            ...
            // Confirmar envío moderno
            modernConfirm(`¿Confirmas que quieres generar el contrato y enviarlo a ${userEmail}?`, () => {
                console.log('✅ Usuario confirmó el envío');
                proceedWithGeneration(userEmail);
            });
            return;
        }

        function proceedWithGeneration(userEmail) {
            console.log('✅ Usuario confirmó el envío');
            console.log('📧 Email recibido en proceedWithGeneration:', userEmail);

            // Ocultar la sección de email
        ...
        // Funciones de la pantalla de carga moderna
        function showTramitfyLoading() {
            const overlay = document.getElementById('tramitfy-loading');
            overlay.classList.add('active');
            
            // Simular progreso de pasos
            setTimeout(() => updateLoadingStep('step-generating'), 800);
            setTimeout(() => updateLoadingStep('step-sending'), 2000);
            setTimeout(() => updateLoadingStep('step-saving'), 3200);
        }

        function hideTramitfyLoading() {
            const overlay = document.getElementById('tramitfy-loading');
            overlay.classList.remove('active');
            
            // Reset pasos para próxima vez
            setTimeout(() => {
                resetLoadingSteps();
            }, 500);
        }
        ...
        function updateLoadingStep(stepId) {
            ...
            const currentStep = document.querySelector('.tramitfy-loading-step.active');
            if (currentStep) {
        ...
        function resetLoadingSteps() {
            ...
            document.querySelectorAll('.tramitfy-loading-step').forEach((step, index) => {
        ...
        // Generar y enviar PDF del contrato (con pantalla de carga)
        function generarYEnviarContratoPDF() {
            ...
            // Ya no enviamos archivos PDF - funcionalidad eliminada
            ...
            .then(responseText => {
                ...
                if (data.success) {
                    ...
                    // Ocultar pantalla de carga y mostrar confirmación elegante
                    hideTramitfyLoading();
                    setTimeout(() => {
                        showSuccessConfirmation(contratoData.userEmail);
                    }, 300);
                } else {
                    ...
                    hideTramitfyLoading();
                    setTimeout(() => {
                        showNotification('error', 'Error al generar el contrato', 
                            (data.data || 'Error desconocido') + '. Intenta de nuevo en unos minutos.', 10000);
                    }, 300);
                }
            })
            .catch(error => {
                ...
                hideTramitfyLoading();
                setTimeout(() => {
                    showNotification('error', 'Error al generar el PDF', error.message + '. Revisa la consola del navegador (F12) para más detalles.', 10000);
                }, 300);
        ...
        function enviarContrato() {
            ...
            // Archivos PDF eliminados - no necesarios

            formData.append('nonce', '<?php echo wp_create_nonce("contrato_email_nonce"); ?>');
        ...
        function showModernConfirm(title, message, onConfirm, onCancel = null) {
            ...
            modalActions.innerHTML = `
                <button class="modern-modal-btn secondary" onclick="closeModernModal(${onCancel ? 'true' : 'false'})">
                    Cancelar
                </button>
                <button class="modern-modal-btn primary" onclick="confirmModernModal()">
                    Confirmar
                </button>
            `;
            ...
            const handleEsc = (e) => {
                if (e.key === 'Escape') {
                    closeModernModal(onCancel ? true : false);
        ...
        function confirmModernModal() {
            const modal = document.getElementById('modern-modal');
            if (modal._onConfirm) {
                modal._onConfirm();
            }
            closeModernModal(false);
        }

        function closeModernModal(triggerCancel = false) {
            const modal = document.getElementById('modern-modal');
            if (triggerCancel && modal._onCancel) {
                modal._onCancel();
            }
        ...
        // ===== REEMPLAZOS DE ALERT Y CONFIRM =====
        function modernAlert(message, type = 'info') {
            showNotification(type, type === 'error' ? 'Error' : 'Información', message);
        }

        function modernConfirm(message, callback) {
            showModernConfirm('Confirmación', message, callback);
        }
        ...
        function showSuccessConfirmation(userEmail) {
            // Crear overlay de fondo
            const overlay = document.createElement('div');
            overlay.className = 'modern-modal active';
            overlay.style.background = 'rgba(0,0,0,0.7)';
            
            // Crear confirmación de éxito
            const confirmation = document.createElement('div');
            confirmation.className = 'success-confirmation';
            confirmation.innerHTML = `
                <span class="success-icon">✅</span>
                <h3 class="success-title">¡Contrato Enviado!</h3>
                <p class="success-message">
                    Tu contrato de compra-venta ha sido generado exitosamente y enviado por email.
                </p>
                <div class="success-details">
                    📧 <strong>Enviado a:</strong> ${userEmail}<br>
                    📄 <strong>Incluye:</strong> Contrato PDF listo para firmar<br>
                    ⏰ <strong>Tiempo:</strong> Recepción en 1-2 minutos
                </div>
                <div class="success-actions">
                    <button class="success-btn primary" onclick="closeSuccessConfirmation()">
                        Perfecto, entendido
                    </button>
                    <button class="success-btn secondary" onclick="goToServices()">
                        Ver servicios de tramitación
                    </button>
                </div>
            `;
        ...
        function closeSuccessConfirmation() {
            const overlay = document.querySelector('.success-confirmation').closest('.modern-modal');
            if (overlay) {
                overlay.remove();
            }
        }
...
function enviar_contrato_compraventa() {
    ...
    if (!empty($contrato_data['clausulas'])) {
        $clausulas_descriptions = [
            'itp' => 'El comprador se hace cargo del ITP (6-8% del valor según CCAA)',
            'tramitacion' => 'Gastos de cambio de titularidad a cargo del comprador',
            'inspeccion' => 'Embarcación aceptada tras inspección en estado actual',
            'seguro' => 'Comprador contratará seguro obligatorio antes de navegar',
            'deudas' => 'Vendedor garantiza ausencia de deudas pendientes',
            'entrega' => 'Entrega el día del pago completo en lugar actual',
            'garantia' => 'Venta sin garantía comercial, solo legal por vicios graves',
            'motor' => 'Motor probado y funcional en momento de venta'
        ];
    ...
    // Enviar datos al API de Tramitfy para sincronizar con React Dashboard
    if ($sent) {
        $api_data = array(
            ...
            'ano' => $contrato_data['ano'],
            'bastidor' => $contrato_data['bastidor'],
            'matricula' => $contrato_data['matricula'],
            'precio' => $contrato_data['precio'],
            'formaPago' => $contrato_data['formaPago'],
            'lugarEntrega' => $contrato_data['lugarEntrega'],
            'motor' => $contrato_data['motor'],
            'vendedorNombre' => $contrato_data['vendedorNombre'],
            'vendedorDni' => $contrato_data['vendedorDni'],
            'vendedorDireccion' => $contrato_data['vendedorDireccion'],
            'vendedorTelefono' => $contrato_data['vendedorTelefono'],
            ...
            'compradorDireccion' => $contrato_data['compradorDireccion'],
            'compradorTelefono' => $contrato_data['compradorTelefono'],
            'compradorEmail' => $contrato_data['compradorEmail'],
            'clausulas' => json_encode($contrato_data['clausulas']),
            'clausulasPersonalizadas' => $contrato_data['clausulasPersonalizadas'],
            'clientEmail' => $email
        );

        // Enviar al API de forma asíncrona
        wp_remote_post('https://46-202-128-35.sslip.io/api/herramientas/contract/webhook', array(
            'timeout' => 5,
            'headers' => array('Content-Type' => 'application/json'),
            'body' => json_encode($api_data),
            'blocking' => false  // Asíncrono para no bloquear respuesta
        ));
...
function generar_y_enviar_contrato_pdf() {
    ...
    error_log("Tramitfy: Generando contrato...");
    ...
    error_log("Tramitfy: Datos del contrato recopilados para " . $contrato_data['marca'] . " " . $contrato_data['modelo']);
    ...
    if (!empty($contrato_data['clausulas'])) {
        $clausulas_descriptions = [
            'itp' => 'IMPUESTO DE TRANSMISIONES: El comprador se hace cargo del Impuesto de Transmisiones Patrimoniales (ITP), que oscila entre el 6% y 8% del valor de transmisión según la Comunidad Autónoma correspondiente.',
            'tramitacion' => 'GASTOS DE TRAMITACIÓN: Los gastos derivados del cambio de titularidad ante la Capitanía Marítima, así como cualquier tasa administrativa, serán a cargo del comprador.',
            'inspeccion' => 'ESTADO DE LA EMBARCACIÓN: El comprador declara haber inspeccionado exhaustivamente la embarcación, conocer su estado actual y la acepta en las condiciones en que se encuentra.',
            'seguro' => 'SEGURO OBLIGATORIO: El comprador se compromete a contratar el seguro obligatorio de responsabilidad civil antes de la primera navegación tras el cambio de titularidad.',
            'deudas' => 'DEUDAS PENDIENTES: El vendedor garantiza que la embarcación no tiene deudas pendientes con puertos, clubes náuticos, multas de navegación o cualquier otra obligación económica.',
            'entrega' => 'FECHA Y LUGAR DE ENTREGA: La entrega física de la embarcación se realizará el mismo día del pago total del precio en el lugar actualmente fondeada o amarrada.',
            'garantia' => 'LIMITACIÓN DE GARANTÍA: Esta venta se realiza sin garantía comercial. Solo aplicará la garantía legal por vicios ocultos graves no detectables en inspección ordinaria.',
            'motor' => 'ESTADO DEL MOTOR: El motor ha sido probado en presencia del comprador y funciona correctamente en el momento de la venta, sin garantía posterior sobre su funcionamiento.'
        ];
...
";
    ...
    // TEST BÁSICO DE EMAIL - DESHABILITADO
    error_log("Tramitfy: === TEST BÁSICO DE EMAIL DESHABILITADO ===");
...
TERCERA.- TRANSMISIÓN DE RIESGOS: La transmisión de riesgos se producirá en el momento de la entrega efectiva de la embarcación, momento en que EL COMPRADOR asumirá todos los riesgos inherentes a la misma.

CUARTA.- CARGAS Y GRAVÁMENES: EL VENDEDOR garantiza que la embarcación se encuentra libre de cargas, gravámenes, embargos o cualquier limitación de dominio, respondiendo de la existencia de vicios ocultos del derecho de propiedad.

QUINTA.- OBLIGACIONES FISCALES: Cada parte asumirá las obligaciones fiscales que le correspondan según la legislación vigente. EL COMPRADOR se hace cargo del Impuesto de Transmisiones Patrimoniales y demás tributos aplicables.

SEXTA.- CAMBIO DE TITULARIDAD: Ambas partes se comprometen a realizar todas las gestiones necesarias para el cambio de titularidad ante las autoridades competentes en el plazo máximo de treinta días desde la firma del presente contrato.

SÉPTIMA.- ENTREGA: La entrega de la embarcación se realizará en ' . (!empty($contrato_data['lugarEntrega']) ? $contrato_data['lugarEntrega'] : 'el lugar donde actualmente se encuentra') . ', corriendo por cuenta de EL COMPRADOR los gastos de traslado si los hubiere.';
...
Y en prueba de conformidad con cuanto antecede, firman el presente contrato por duplicado y a un solo efecto en el lugar y fecha indicados en el encabezamiento.';
    ...
    <head>
        ...
        <title>Contrato de Compra-Venta de Embarcación</title>
    </head>
        ...
        <div style='max-width: 800px; margin: 0 auto; background-color: #ffffff; border: 1px solid #dee2e6;'>
            ...
            <div style='background-color: #1a365d; padding: 25px 30px; border-bottom: 3px solid #2c5282;'>
                ...
                <p style='color: #cbd5e0; margin: 8px 0 0 0; font-size: 14px; text-align: center; font-style: italic;'>
                    Contrato generado por Tramitfy.es
                </p>
            </div>
            ...
            <div style='background: #e6f3ff; border: 1px solid #4299e1; padding: 20px; margin: 20px 30px; border-radius: 4px;'>
                <h3 style='color: #2b6cb0; margin: 0 0 12px 0; font-size: 16px; font-weight: bold;'>CONTRATO ADJUNTO</h3>
    ...
    // NOTA: Archivo temporal se limpiará DESPUÉS de subir a Tramitfy
    ...
    if ($sent) {
            ...
            <div style='max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8f9fa;'>
                ...
                <div style='background-color: white; padding: 25px; margin-top: 0;'>
                    ...
                    <div style='background-color: #e6fffa; border: 1px solid #81e6d9; padding: 15px; margin-top: 20px; border-radius: 4px;'>
                        ...
                        <p style='margin: 5px 0 0 0; color: #285e61; font-size: 14px;'>El cliente ha recibido su contrato de compra-venta.</p>
                    </div>
                </div>
        ...
        $contract_id = time() . '000';

        // URL temporal (se actualizará después de subir el PDF)
        $file_url = '';
        ...
        // Webhook será enviado después del PDF para evitar duplicados

        // Subir PDF al servidor Tramitfy (optimizado - menos logs)
        if (file_exists($file_path)) {
            $pdf_content = file_get_contents($file_path);
            $pdf_data = base64_encode($pdf_content);
            error_log("Tramitfy: PDF procesado correctamente - " . strlen($pdf_data) . " chars");
        } else {
            error_log("Tramitfy: ERROR - File does not exist: " . $file_path);
            $pdf_data = '';
        }
        ...
        // Upload PDF de forma asíncrona para mayor velocidad
        wp_remote_post('https://46-202-128-35.sslip.io/api/herramientas/contracts/upload-pdf', array(
            'timeout' => 5,
            'headers' => array('Content-Type' => 'application/json'),
        ...
        error_log('Tramitfy: PDF upload iniciado en background');
        $upload_status = 'Iniciado en background';

        // Limpiar archivo temporal tras breve delay (upload asíncrono)
        wp_schedule_single_event(time() + 30, 'tramitfy_cleanup_contract_pdf', array($file_path));

        error_log("Tramitfy: ====== ENVIANDO RESPUESTA ÉXITO AL JAVASCRIPT ======");
        wp_send_json_success([
            'message' => 'Contrato generado y enviado por email correctamente',
            'debug' => [
                'file_path' => $file_path,
                'file_exists' => false, // Ya limpiado
                'file_size' => 0, // Ya limpiado
                'upload_status' => $upload_status,
                'pdf_data_length' => strlen($pdf_data)
            ]
        ]);
    } else {
...
// Hook para limpiar archivos PDF temporales
add_action('tramitfy_cleanup_contract_pdf', function($file_path) {
    if (file_exists($file_path)) {
        unlink($file_path);
        error_log("Tramitfy: ✅ Archivo temporal limpiado tras delay: " . basename($file_path));
    }
});
?>