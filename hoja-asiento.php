...
define('HOJA_ASIENTO_STRIPE_TEST_SECRET_KEY', 'YOUR_STRIPE_TEST_KEY_HERE');

define('HOJA_ASIENTO_STRIPE_LIVE_PUBLIC_KEY', 'YOUR_STRIPE_LIVE_PUBLIC_KEY_HERE');
define('HOJA_ASIENTO_STRIPE_LIVE_SECRET_KEY', 'YOUR_STRIPE_LIVE_KEY_HERE');
...
function hoja_asiento_form_shortcode() {
    ...
    (function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let currentPrice = <?php echo HOJA_ASIENTO_SERVICE_PRICE; ?>;
            const basePrice = <?php echo HOJA_ASIENTO_SERVICE_PRICE; ?>;
