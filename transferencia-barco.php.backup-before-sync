...
function transferencia_barco_shortcode() {
    ...
    $datos_fabricantes = tpb_cargar_datos_csv('Barco');
                ...
                <aside class="tramitfy-sidebar">
                    ...
                    <div class="sidebar-content" data-step="page-vehiculo">
                        <div class="sidebar-body">
                            <!-- Precio fijo en la parte superior -->
                            <div style="background: rgba(255, 255, 255, 0.25); padding: 20px; border-radius: 10px; color: #ffffff; margin-bottom: 25px;">
                                <div style="font-size: 14px; margin-bottom: 8px; opacity: 0.9;">Tu tramitación completa</div>
                                <div style="font-size: 32px; font-weight: 700; margin-bottom: 12px;">134,95€</div>
                            ...
                            <!-- Mensaje de urgencia -->
                            <div style="background: rgba(255, 255, 255, 0.15); padding: 15px; border-radius: 8px; border-left: 4px solid #ffffff; margin-bottom: 20px;">
                                <p style="margin: 0; color: #ffffff; font-size: 13px; line-height: 1.6;">
                                    <strong>⚡ En 24 horas:</strong> Entrega en capitanía y documentos provisionales
                                </p>
                            </div>
                    ...
                    <div class="sidebar-content" data-step="page-precio">
                        <div class="sidebar-body">
                            <!-- Nuestros servicios arriba del todo -->
                            <div style="background: rgba(255, 255, 255, 0.25); padding: 20px; border-radius: 10px; color: #ffffff; margin-bottom: 25px;">
                            ...
                            <!-- Desglose del trámite con cálculo dinámico del ITP -->
                            <div style="background: rgba(255, 255, 255, 0.15); padding: 18px; border-radius: 10px; color: #ffffff; margin-bottom: 20px;">
                                <h4 style="margin: 0 0 15px 0; font-size: 15px; color: #ffffff; font-weight: 600;">
                                    <i class="fa-solid fa-calculator"></i> Desglose del trámite
                                </h4>
                                <div style="font-size: 13px; line-height: 1.6;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; padding: 8px 0;">
                                        <span style="opacity: 0.9;">Valor fiscal:</span>
                    ...
                    <div class="sidebar-content" data-step="page-pago">
                        <div class="sidebar-body">
                            ...
                            <!-- Datos del Vehículo -->
                            <div style="background: rgba(255, 255, 255, 0.15); padding: 15px; border-radius: 8px; margin-bottom: 15px;">
                                <h4 style="color: #ffffff; font-size: 14px; margin-bottom: 10px;"><i class="fa-solid fa-ship"></i> Vehículo</h4>
                                <div style="font-size: 13px; color: rgba(255, 255, 255, 0.9); line-height: 1.8;">
                                    <p style="margin: 5px 0;"><strong>Tipo:</strong> Barco</p>
                        ...
                        <div class="accordion-content-section">
                            <div class="additional-service-item">
                                <label class="service-checkbox">
                                    ...
                                    <span class="checkbox-custom"></span>
                                    <div class="service-info">
                                        <span class="service-name">Cambiar el nombre de la embarcación</span>
                    ...
                    <div class="upload-grid">
                        <div class="upload-row">
                            <div class="upload-item">
                                <label id="label-hoja-asiento" for="upload-hoja-asiento">Copia hoja de registro marítimo</label>
            ...
            <div id="stripe-container" style="max-width: 600px; margin: 0 auto;">
                ...
                <div class="payment-security" style="margin: 20px 0; text-align: center; padding: 15px; background-color: #f8f9fa; border-radius: 8px;">
                    <div class="security-badges" style="display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap;">
                        <div class="security-badge" style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #666;">
                            <i class="fa-solid fa-lock" style="color: #4f46e5;"></i>
                            <span>Pago Seguro</span>
                        </div>
                        <div class="security-badge" style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #666;">
                            <i class="fa-solid fa-shield-alt" style="color: #4f46e5;"></i>
                            <span>Datos Encriptados</span>
                        </div>
                        <div class="security-badge" style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #666;">
                            <i class="fa-brands fa-stripe" style="color: #4f46e5;"></i>
                ...
                <div id="payment-message" class="hidden" style="margin-top: 20px; padding: 15px; border-radius: 8px; text-align: center;"></div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePaymentSummary() {
            ...
            const vehicleType = 'Barco'; // Fijo para transferencia de barcos
        ...
        function populateManufacturers() {
            const vehicleType = 'Barco'; // Fijo para transferencia de barcos
            const csvFile = 'data.csv'; // Fijo para barcos
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (adminAutofillBtn) {
            adminAutofillBtn.addEventListener('click', async function() {
                ...
                manufacturerSelect.value = 'YAMAHA'; // Para barco, usar fabricante de data.csv
 ...
 */
add_action('wp_ajax_create_payment_intent', 'tpb_create_payment_intent');
add_action('wp_ajax_nopriv_create_payment_intent', 'tpb_create_payment_intent');
 ...
 */
add_action('wp_ajax_validate_coupon_code_XXX', 'tpb_validate_coupon_code');
...
add_action('wp_ajax_nopriv_validate_coupon_code_XXX', 'tpb_validate_coupon_code');
...
function tpb_submit_form() {
    ...
    <body style='font-family: Arial, sans-serif;'>
        <div style='max-width:600px; margin:auto; padding:20px; background:#f9f9f9; border:1px solid #e0e0e0; border-radius:10px;'>
            ...
            <p>Hemos recibido su solicitud de transferencia de barco con el ID: <strong>{$tramite_id}</strong></p>
